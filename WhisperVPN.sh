...
echo -e "$red                        ➡$red [\e[35m2\e[35m] About Us"
echo -e "$red                        ➡$red [\e[35m3\e[35m] Update Script"
echo -e "$red                        ➡$red [\e[35m4\e[35m] Report Issues"
echo -e "$red                        ➡$red [\e[35m5\e[35m] Exit"
   
echo " "
echo " "
echo -e "$red               >＞＞＞＞＞$red [SELECT]$red ＜＜＜＜＜<$red"
echo " "
